...
static const _SystemStatus_type_support_symbol_names_t _SystemStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, human_hand_msgs, msg, SystemStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, human_hand_msgs, msg, SystemStatus)),
  }
};
...
{
  return &::human_hand_msgs::msg::rosidl_typesupport_cpp::SystemStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, human_hand_msgs, msg, SystemStatus)() {
  return get_message_type_support_handle<human_hand_msgs::msg::SystemStatus>();
}
