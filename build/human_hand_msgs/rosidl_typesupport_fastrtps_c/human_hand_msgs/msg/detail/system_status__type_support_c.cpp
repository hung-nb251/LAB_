...
#include "human_hand_msgs/msg/detail/system_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // message, node_name, status
#include "rosidl_runtime_c/string_functions.h"  // message, node_name, status
...
using _SystemStatus__ros_msg_type = human_hand_msgs__msg__SystemStatus;
...
size_t get_serialized_size_human_hand_msgs__msg__SystemStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SystemStatus__ros_msg_type * ros_message = static_cast<const _SystemStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SystemStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_human_hand_msgs__msg__SystemStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_human_hand_msgs
size_t max_serialized_size_human_hand_msgs__msg__SystemStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = human_hand_msgs__msg__SystemStatus;
    is_plain =
      (
...
static size_t _SystemStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_human_hand_msgs__msg__SystemStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, human_hand_msgs, msg, SystemStatus)() {
