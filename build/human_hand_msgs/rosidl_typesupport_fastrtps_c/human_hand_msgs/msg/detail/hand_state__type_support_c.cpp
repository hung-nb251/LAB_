...
#include "human_hand_msgs/msg/detail/hand_state__rosidl_typesupport_fastrtps_c.h"
...
using _HandState__ros_msg_type = human_hand_msgs__msg__HandState;
...
size_t get_serialized_size_human_hand_msgs__msg__HandState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HandState__ros_msg_type * ros_message = static_cast<const _HandState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _HandState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_human_hand_msgs__msg__HandState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_human_hand_msgs
size_t max_serialized_size_human_hand_msgs__msg__HandState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = human_hand_msgs__msg__HandState;
    is_plain =
      (
...
static size_t _HandState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_human_hand_msgs__msg__HandState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, human_hand_msgs, msg, HandState)() {
