...
#include "human_hand_msgs/msg/detail/hand_prediction__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_human_hand_msgs
...
using _HandPrediction__ros_msg_type = human_hand_msgs__msg__HandPrediction;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HandPrediction__ros_msg_type * ros_message = static_cast<const _HandPrediction__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _HandPrediction__ros_msg_type * ros_message = static_cast<_HandPrediction__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_human_hand_msgs__msg__HandPrediction(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HandPrediction__ros_msg_type * ros_message = static_cast<const _HandPrediction__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _HandPrediction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_human_hand_msgs__msg__HandPrediction(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_human_hand_msgs
size_t max_serialized_size_human_hand_msgs__msg__HandPrediction(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = human_hand_msgs__msg__HandPrediction;
    is_plain =
      (
...
static size_t _HandPrediction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_human_hand_msgs__msg__HandPrediction(
...
static message_type_support_callbacks_t __callbacks_HandPrediction = {
  "human_hand_msgs::msg",
  "HandPrediction",
...
static rosidl_message_type_support_t _HandPrediction__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HandPrediction,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, human_hand_msgs, msg, HandPrediction)() {
  return &_HandPrediction__type_support;
}
