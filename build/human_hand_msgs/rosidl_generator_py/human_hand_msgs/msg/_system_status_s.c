...
bool human_hand_msgs__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("human_hand_msgs.msg._system_status.SystemStatus", full_classname_dest, 47) == 0);
  }
  human_hand_msgs__msg__SystemStatus * ros_message = _ros_message;
  {  // header
...
PyObject * human_hand_msgs__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("human_hand_msgs.msg._system_status");
