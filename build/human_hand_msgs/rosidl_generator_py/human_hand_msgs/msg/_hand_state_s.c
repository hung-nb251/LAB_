...
bool human_hand_msgs__msg__hand_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("human_hand_msgs.msg._hand_state.HandState", full_classname_dest, 41) == 0);
  }
  human_hand_msgs__msg__HandState * ros_message = _ros_message;
  {  // header
...
PyObject * human_hand_msgs__msg__hand_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("human_hand_msgs.msg._hand_state");
