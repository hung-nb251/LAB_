...
motoros2_interfaces__msg__InitTrajEnum__create()
{
  ...
  motoros2_interfaces__msg__InitTrajEnum * msg = (motoros2_interfaces__msg__InitTrajEnum *)allocator.allocate(sizeof(motoros2_interfaces__msg__InitTrajEnum), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(motoros2_interfaces__msg__InitTrajEnum));
  bool success = motoros2_interfaces__msg__InitTrajEnum__init(msg);
  if (!success) {
...
motoros2_interfaces__msg__InitTrajEnum__destroy(motoros2_interfaces__msg__InitTrajEnum * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    motoros2_interfaces__msg__InitTrajEnum__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
motoros2_interfaces__msg__InitTrajEnum__Sequence__init(motoros2_interfaces__msg__InitTrajEnum__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motoros2_interfaces__msg__InitTrajEnum * data = NULL;

  if (size) {
    data = (motoros2_interfaces__msg__InitTrajEnum *)allocator.zero_allocate(size, sizeof(motoros2_interfaces__msg__InitTrajEnum), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = motoros2_interfaces__msg__InitTrajEnum__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        motoros2_interfaces__msg__InitTrajEnum__fini(&data[i - 1]);
      }
...
motoros2_interfaces__msg__InitTrajEnum__Sequence__fini(motoros2_interfaces__msg__InitTrajEnum__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      motoros2_interfaces__msg__InitTrajEnum__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motoros2_interfaces__msg__InitTrajEnum__Sequence * array = (motoros2_interfaces__msg__InitTrajEnum__Sequence *)allocator.allocate(sizeof(motoros2_interfaces__msg__InitTrajEnum__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = motoros2_interfaces__msg__InitTrajEnum__Sequence__init(array, size);
  if (!success) {
...
motoros2_interfaces__msg__InitTrajEnum__Sequence__destroy(motoros2_interfaces__msg__InitTrajEnum__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    motoros2_interfaces__msg__InitTrajEnum__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
motoros2_interfaces__msg__InitTrajEnum__Sequence__are_equal(const motoros2_interfaces__msg__InitTrajEnum__Sequence * lhs, const motoros2_interfaces__msg__InitTrajEnum__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!motoros2_interfaces__msg__InitTrajEnum__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  motoros2_interfaces__msg__InitTrajEnum__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(motoros2_interfaces__msg__InitTrajEnum);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    motoros2_interfaces__msg__InitTrajEnum * data =
      (motoros2_interfaces__msg__InitTrajEnum *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!motoros2_interfaces__msg__InitTrajEnum__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          motoros2_interfaces__msg__InitTrajEnum__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!motoros2_interfaces__msg__InitTrajEnum__copy(
