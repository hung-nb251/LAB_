...
#ifndef MOTOROS2_INTERFACES__SRV__DETAIL__WRITE_GROUP_IO__FUNCTIONS_H_
#define MOTOROS2_INTERFACES__SRV__DETAIL__WRITE_GROUP_IO__FUNCTIONS_H_
...
/// Initialize srv/WriteGroupIO message.
/**
...
/// Finalize srv/WriteGroupIO message.
/**
...
/// Create srv/WriteGroupIO message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * motoros2_interfaces__srv__WriteGroupIO_Request__init().
...
/// Destroy srv/WriteGroupIO message.
/**
 * It calls
 * motoros2_interfaces__srv__WriteGroupIO_Request__fini()
...
/// Check for srv/WriteGroupIO message equality.
/**
...
/// Copy a srv/WriteGroupIO message.
/**
...
/// Initialize array of srv/WriteGroupIO messages.
/**
...
/// Finalize array of srv/WriteGroupIO messages.
/**
 * It calls
 * motoros2_interfaces__srv__WriteGroupIO_Request__fini()
...
/// Create array of srv/WriteGroupIO messages.
/**
 * It allocates the memory for the array and calls
 * motoros2_interfaces__srv__WriteGroupIO_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/WriteGroupIO messages.
/**
 * It calls
 * motoros2_interfaces__srv__WriteGroupIO_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/WriteGroupIO message array equality.
/**
...
/// Copy an array of srv/WriteGroupIO messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * motoros2_interfaces__srv__WriteGroupIO_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_motoros2_interfaces
...
/**
 * It calls
 * motoros2_interfaces__srv__WriteGroupIO_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_motoros2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * motoros2_interfaces__srv__WriteGroupIO_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_motoros2_interfaces
...
/**
 * It calls
 * motoros2_interfaces__srv__WriteGroupIO_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOTOROS2_INTERFACES__SRV__DETAIL__WRITE_GROUP_IO__FUNCTIONS_H_
