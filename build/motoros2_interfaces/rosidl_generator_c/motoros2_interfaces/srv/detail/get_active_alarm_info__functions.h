...
#ifndef MOTOROS2_INTERFACES__SRV__DETAIL__GET_ACTIVE_ALARM_INFO__FUNCTIONS_H_
#define MOTOROS2_INTERFACES__SRV__DETAIL__GET_ACTIVE_ALARM_INFO__FUNCTIONS_H_
...
/// Initialize srv/GetActiveAlarmInfo message.
/**
...
/// Finalize srv/GetActiveAlarmInfo message.
/**
...
/// Create srv/GetActiveAlarmInfo message.
/**
...
/// Destroy srv/GetActiveAlarmInfo message.
/**
 * It calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Request__fini()
...
/// Check for srv/GetActiveAlarmInfo message equality.
/**
...
/// Copy a srv/GetActiveAlarmInfo message.
/**
...
/// Initialize array of srv/GetActiveAlarmInfo messages.
/**
...
/// Finalize array of srv/GetActiveAlarmInfo messages.
/**
 * It calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Request__fini()
...
/// Create array of srv/GetActiveAlarmInfo messages.
/**
 * It allocates the memory for the array and calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetActiveAlarmInfo messages.
/**
 * It calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetActiveAlarmInfo message array equality.
/**
...
/// Copy an array of srv/GetActiveAlarmInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_motoros2_interfaces
...
/**
 * It calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_motoros2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_motoros2_interfaces
...
/**
 * It calls
 * motoros2_interfaces__srv__GetActiveAlarmInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOTOROS2_INTERFACES__SRV__DETAIL__GET_ACTIVE_ALARM_INFO__FUNCTIONS_H_
