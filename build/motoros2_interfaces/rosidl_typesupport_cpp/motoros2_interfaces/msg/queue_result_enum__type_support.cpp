...
static const _QueueResultEnum_type_support_symbol_names_t _QueueResultEnum_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, msg, QueueResultEnum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, msg, QueueResultEnum)),
  }
};
...
{
  return &::motoros2_interfaces::msg::rosidl_typesupport_cpp::QueueResultEnum_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motoros2_interfaces, msg, QueueResultEnum)() {
  return get_message_type_support_handle<motoros2_interfaces::msg::QueueResultEnum>();
}
