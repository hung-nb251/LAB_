...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, motoros2_interfaces, srv, ReadGroupIO)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<motoros2_interfaces::srv::ReadGroupIO>();
}
