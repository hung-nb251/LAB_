...
static const _AlarmCauseRemedy_type_support_symbol_names_t _AlarmCauseRemedy_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motoros2_interfaces, msg, AlarmCauseRemedy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motoros2_interfaces, msg, AlarmCauseRemedy)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, motoros2_interfaces, msg, AlarmCauseRemedy)() {
  return &::motoros2_interfaces::msg::rosidl_typesupport_c::AlarmCauseRemedy_message_type_support_handle;
}
