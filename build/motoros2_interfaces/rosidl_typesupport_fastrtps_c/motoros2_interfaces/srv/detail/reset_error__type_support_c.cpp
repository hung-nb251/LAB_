...
#include "motoros2_interfaces/srv/detail/reset_error__rosidl_typesupport_fastrtps_c.h"
...
using _ResetError_Request__ros_msg_type = motoros2_interfaces__srv__ResetError_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _ResetError_Request__ros_msg_type * ros_message = static_cast<_ResetError_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
size_t get_serialized_size_motoros2_interfaces__srv__ResetError_Request(
  const void * untyped_ros_message,
...
static uint32_t _ResetError_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motoros2_interfaces__srv__ResetError_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motoros2_interfaces
size_t max_serialized_size_motoros2_interfaces__srv__ResetError_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motoros2_interfaces__srv__ResetError_Request;
    is_plain =
      (
...
static size_t _ResetError_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_motoros2_interfaces__srv__ResetError_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motoros2_interfaces, srv, ResetError_Request)() {
...
using _ResetError_Response__ros_msg_type = motoros2_interfaces__srv__ResetError_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _ResetError_Response__ros_msg_type * ros_message = static_cast<_ResetError_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: result_code
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motoros2_interfaces
size_t get_serialized_size_motoros2_interfaces__srv__ResetError_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ResetError_Response__ros_msg_type * ros_message = static_cast<const _ResetError_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_motoros2_interfaces__srv__ResetError_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motoros2_interfaces
size_t max_serialized_size_motoros2_interfaces__srv__ResetError_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = motoros2_interfaces__srv__ResetError_Response;
    is_plain =
      (
...
static size_t _ResetError_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_motoros2_interfaces__srv__ResetError_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motoros2_interfaces, srv, ResetError_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motoros2_interfaces, srv, ResetError)() {
