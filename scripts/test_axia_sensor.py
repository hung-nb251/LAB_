...
def main():
    if len(sys.argv) == 1:
        print("Sử dụng: sudo python3 scripts/test_axia_sensor.py <interface_name>")
        print("Chạy 'sudo python3 scripts/test_axia_sensor.py --list' để xem danh sách giao diện mạng (thường là eth0, enp3s0...).")
        return
